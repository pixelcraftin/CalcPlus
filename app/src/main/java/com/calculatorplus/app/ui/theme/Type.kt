...
fun getTypography(useDotMatrix: Boolean): Typography {
    val fontFamily = if (useDotMatrix) DotoFontFamily else PlusJakartaSansFontFamily
    val fontSynthesis = if (useDotMatrix) FontSynthesis.None else FontSynthesis.All
