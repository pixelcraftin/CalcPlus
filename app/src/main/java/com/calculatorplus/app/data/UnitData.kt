...
object UnitData {
    val categories = listOf(
        "Angle", "Area", "Currency (Mock)", "Data", "Energy", 
    ...
    val unitsMap = mapOf(
        ...
        "Currency (Mock)" to listOf(
            UnitItem("US Dollar", "USD", "Currency (Mock)", 1.0),
            UnitItem("Euro", "EUR", "Currency (Mock)", 1.08),
            UnitItem("British Pound", "GBP", "Currency (Mock)", 1.27),
            UnitItem("Indian Rupee", "INR", "Currency (Mock)", 0.012),
            UnitItem("Japanese Yen", "JPY", "Currency (Mock)", 0.0063),
            UnitItem("Australian Dollar", "AUD", "Currency (Mock)", 0.66),
            UnitItem("Canadian Dollar", "CAD", "Currency (Mock)", 0.73),
            UnitItem("Chinese Yuan", "CNY", "Currency (Mock)", 0.14)
        ),
        "Data" to listOf(
